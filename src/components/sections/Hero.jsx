...
export default function Hero() {
    ...
    return (
        <section id="home" className="relative pt-28 pb-16 md:pt-32 md:pb-20 px-6 md:px-10 lg:px-16 overflow-hidden bg-white min-h-[90vh] flex items-center">
            {/* Background Pattern */}
            ...
            <div className="max-w-[1440px] mx-auto w-full grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
                {/* Left Column */}
                <motion.div
                    className="max-w-2xl"
                ...
                >
                    <motion.h1
                        ...
                        className="font-bold text-primary mb-6 tracking-tight text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight md:leading-snug lg:leading-[72px]"
                    >
                ...
                >
                    <div className="relative w-full aspect-square sm:aspect-[4/3] lg:aspect-auto lg:h-[500px] max-w-md md:max-w-lg lg:max-w-none lg:w-[85%] mx-auto">
                        <img
                            src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=1000"
                            alt="Team discussing at table"
                            className="relative w-full h-full object-cover rounded-[2rem] sm:rounded-[2.5rem] shadow-xl z-20"
                        />
                        ...
                        <motion.div
                            ...
                            animate="animate"
                            className="absolute -left-4 sm:-left-12 top-[10%] sm:top-[15%] z-30 bg-primary px-4 sm:px-5 py-2 rounded-lg shadow-lg flex items-center justify-center gap-2"
                        >
                        ...
                        >
                            ...
                            <span className="text-white font-medium text-xs sm:text-sm whitespace-nowrap">Web Design</span>
                        </motion.div>

                        {/* Blue dotted circle decoration */}
                        <div className="absolute -bottom-6 -left-6 sm:-bottom-8 sm:-left-8 w-20 h-20 sm:w-24 sm:h-24 rounded-full border-[4px] sm:border-[6px] border-dotted border-primary opacity-80 z-10 animate-[spin_10s_linear_infinite]"></div>
                        ...
                        <motion.div
                            ...
                            className="absolute -bottom-6 sm:-bottom-4 left-4 sm:-left-4 z-30 bg-[#1A1A2E] px-4 sm:px-5 py-2 rounded-lg shadow-lg flex items-center justify-center"
                        >
