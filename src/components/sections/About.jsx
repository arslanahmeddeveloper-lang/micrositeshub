        ...
        <section id="about" className="section-padding bg-white relative">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <div className="flex flex-wrap items-center gap-8 md:gap-12">
                        ...
                        <div className="relative w-24 h-24 hidden sm:block">
                            ...
                            <div className="absolute inset-0 m-auto w-12 h-12 bg-primary rounded-full flex items-center justify-center text-white">
                ...
                <motion.div
                    ...
                    viewport={{ once: true, margin: "-100px" }}
                    className="relative w-full max-w-lg mx-auto lg:max-w-none pt-12 lg:pt-0"
                >
                    <div className="relative z-10 w-[80%] ml-auto">
                        <img
                            src="https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80&w=800"
                            alt="Web design process"
                            className="w-full rounded-[2rem] shadow-xl object-cover aspect-square"
                        />
                    </div>

                    <div className="absolute bottom-[-10%] left-0 w-[65%] z-20">
                        <img
                            src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&q=80&w=800"
                            alt="Team collaboration"
                            className="w-full rounded-[2rem] shadow-2xl object-cover border-8 border-white aspect-[4/3]"
                        />
                    </div>

                    {/* Decorative Dot Pattern */}
                    <div className="absolute -top-10 right-10 w-32 h-32 bg-[radial-gradient(circle,#4F46E5_2px,transparent_2px)] bg-[length:20px_20px] opacity-20 z-0"></div>
                </motion.div>
            </div>
        </section>
    );
