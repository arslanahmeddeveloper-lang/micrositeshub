...
export default function Contact() {
    ...
    return (
        <section id="contact" className="section-padding bg-bgsoft">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-5xl font-bold text-dark mb-6 leading-tight">
                    ...
                    <div className="flex flex-col space-y-4">
                        <div className="flex bg-white p-6 rounded-xl shadow-sm border border-gray-100 items-start gap-6">
                        ...
                        <div className="flex bg-white p-6 rounded-xl shadow-sm border border-gray-100 items-start gap-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500">hello@agency.com</p>
                ...
                >
                    <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-2xl border border-gray-100 relative overflow-hidden">
                        ...
                        <h3 className="text-2xl font-bold text-dark mb-3 relative z-10">Place Your Order In</h3>
                        <p className="text-gray-500 mb-8 text-sm relative z-10">Fill out the following information and our team will get back to you.</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full h-12 px-4 rounded-xl border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-primary focus:outline-none transition-all bg-slate-50 text-dark placeholder-gray-400"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={4}
                                    className="w-full p-4 rounded-xl border-none ring-1 ring-gray-200 focus:ring-2 focus:ring-primary focus:outline-none transition-all bg-slate-50 text-dark placeholder-gray-400 resize-none"
