            ...
            <div className="max-w-[1440px] mx-auto text-center">
                ...
                >
                    ...
                    <p className="text-gray-500 text-sm sm:text-base leading-relaxed">
                        Our approach is built on custom execution, performance insights, and a steadfast dedication to doing things in-house. Partner with us, and you'll soon realize that our team operates at a different tier.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-8">
                    {reasons.map((item, index) => (
                        ...
                        >
                            {/* Blue Ring Icon Container */}
                            <div className="w-20 h-20 rounded-full border-4 border-blue-50 bg-white shadow-sm flex items-center justify-center mb-6 group-hover:scale-110 group-hover:border-blue-100 transition-all duration-300">
                                <div className="w-14 h-14 bg-blue-50/50 rounded-full flex items-center justify-center">
                                    {item.icon}
                                </div>
                            </div>
